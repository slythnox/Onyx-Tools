...
<div style={{ width: '1080px', height: '1080px', position: 'relative' }}>
  ...
  return (
    <div className="flex-1 flex h-full bg-[#120f17] text-zinc-150 relative min-h-0 select-none">
      {/* LEFT SIDEBAR */}
      <div className="absolute top-0 bottom-0 left-0 w-[320px] bg-black/75 backdrop-blur-md border-r border-zinc-900/40 p-4 flex flex-col justify-between shrink-0 z-10">
      ...
      {/* CANVAS PREVIEW */}
      <div ref={canvasParentRef} style={{ backgroundColor: canvasBg }} className="absolute inset-0 w-full h-full z-0 overflow-hidden transition-colors duration-300">
