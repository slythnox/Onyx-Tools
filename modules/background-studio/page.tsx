...
<div style={{ width: '1080px', height: '1080px', position: 'relative' }}>
  ...
  return (
    <div className="flex-1 flex h-full bg-[#120f17] text-zinc-150 min-h-0 select-none">
      {/* LEFT SIDEBAR */}
      ...
      {/* CANVAS PREVIEW */}
      <div ref={canvasParentRef} style={{ backgroundColor: canvasBg }} className="flex-1 h-full relative z-0 overflow-hidden transition-colors duration-300">
